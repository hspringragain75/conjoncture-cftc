...
def build_carburants_data():
    ...
    if gazole and sp95:
        ...
        if evolution:
            ...
            derniere_periode = evolution[-1]['mois']  # ex: "Mar 2026"
            return {
                ...
                "derniere_donnee": derniere_periode
            }
    
    print("  ⚠️ Utilisation des données par défaut")
    # Ajouter la dernière donnée connue pour le fallback
    default_carburants["derniere_donnee"] = default_carburants["evolution"][-1]["mois"] if default_carburants.get("evolution") else "N/A"
