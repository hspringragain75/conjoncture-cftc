...
def build_emplois_vacants_data():
    ...
    # DEBUG : afficher les champs du premier enregistrement pour identifier la structure
    if vacants_raw:
        print(f"  🔍 Champs emplois vacants: {list(vacants_raw[0].keys())}")
        print(f"  🔍 Ex enregistrement: {vacants_raw[0]}")
    if occupes_raw:
        print(f"  🔍 Champs emplois occupés: {list(occupes_raw[0].keys())}")
