...
def build_revue_presse():
    ...
    SOURCES = [
        {
            "nom": "INSEE",
            "url": "https://www.insee.fr/fr/rss/actu.xml",
            "couleur": "#1e40af",
            "emoji": "📊",
        ...
        {
            "nom": "DARES",
            "url": "https://dares.travail-emploi.gouv.fr/rss.xml",
            "couleur": "#065f46",
            "emoji": "👥",
            "tag": "Emploi & travail",
        },
        {
            ...
            "url": "https://www.banque-france.fr/rss/publications.xml",
            "couleur": "#7c3aed",
            "emoji": "🏦",
        ...
        {
            "nom": "Eurostat",
            "url": "https://ec.europa.eu/eurostat/rss/fr/news-rss.xml",
            "couleur": "#0369a1",
            "emoji": "🇪🇺",
            "tag": "Comparaison européenne",
        },
        {
            "nom": "France Travail",
            "url": "https://www.francetravail.fr/accueil/rss/actualites.xml",
            "couleur": "#0891b2",
            "emoji": "🎯",
        ...
        {
            "nom": "UNEDIC",
            "url": "https://www.unedic.org/rss.xml",
            "couleur": "#0f766e",
            "emoji": "🛡️",
            "tag": "Assurance chômage",
        },
        {
            "nom": "Cour des comptes",
            "url": "https://www.ccomptes.fr/fr/rss/publications",
            "couleur": "#dc2626",
            "emoji": "⚖️",
        ...
        {
            "nom": "OFCE",
            "url": "https://www.ofce.sciences-po.fr/rss/blog.xml",
            "couleur": "#7e22ce",
            "emoji": "🔬",
        ...
        {
            "nom": "OCDE",
            "url": "https://www.oecd.org/fr/rss/actu.xml",
            "couleur": "#1d4ed8",
            "emoji": "🌍",
            "tag": "Comparaisons internationales",
        },
    ]
    ...
    def fetch_rss(source):
        ...
        articles = []
        headers = {
            "User-Agent": "Mozilla/5.0 (compatible; CFTC-Dashboard/2.0; +https://cftc.fr)",
        ...
        try:
            ...
            # Gérer Atom (feed/entry) et RSS (channel/item)
            ...
            if is_atom:
                ...
                for entry in entries[:15]:
                    ...
                    titre  = nettoyer_html(get("title"))
                    resume = nettoyer_html(get("summary") or get("content"))
                    lien   = entry.find("atom:link", ns) or entry.find("link")
                    lien   = lien.get("href", "") if lien is not None else ""
                    date_str = get("published") or get("updated")
                    articles.append((titre, resume, lien, date_str))
            else:
                ...
                for item in items[:15]:
                    def getx(tag):
                        el = item.find(tag)
                        return el.text if el is not None else ""
                    titre    = nettoyer_html(getx("title"))
                    resume   = nettoyer_html(getx("description"))
                    lien     = getx("link")
                    date_str = getx("pubDate") or getx("dc:date")
                    articles.append((titre, resume, lien, date_str))
        ...
        result = []
        for titre, resume, lien, date_str in articles:
            if not titre:
                continue
