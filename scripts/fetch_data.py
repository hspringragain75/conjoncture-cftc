...
def build_emplois_vacants_data():
    ...
    def parse_dares_records(records, value_field=None):
        ...
        # Garder tous les trimestres — pas de seuil sur nb_secteurs
        # Les trimestres incomplets seront naturellement écartés par le tri et le slice final
        pass
    ...
    print(f"  🔍 parse: {len(emplois_vacants)} vacants, {len(emplois_occupes)} occupés")
