...
SERIES_IDS = {
    ...
    # === EMPLOI PAR SECTEUR ===
    "emploi_industrie":          "001577235",  # Emplois salariés trimestriels - Industrie (B,C,D,E) - CVS
    "emploi_construction":        "001577236",  # Emplois salariés trimestriels - Construction (F) - CVS
    "emploi_tertiaire_marchand":  "001577237",  # Emplois salariés trimestriels - Tertiaire marchand (G→N,R,S,T) - CVS
    "emploi_tertiaire_nonmarc":   "001796855",  # Emplois salariés trimestriels - Tertiaire non marchand (O,Q) - CVS
    ...
    if emploi_industrie and emploi_constr and emploi_terc_marc:
        ...
        for i in range(nb):
            ...
            trimestres_hist.append({
                ...
                "tertiaire":    round((emploi_terc_marc[i] + tnm) / 1000) if emploi_terc_marc[i] else None,
                "interim":      None,
            })
