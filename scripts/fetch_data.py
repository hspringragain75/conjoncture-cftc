...
def main():
    ...
    data = {
        ...
        "emploi_seniors_detail": {
            "taux_55_64": derniers_seniors.get("taux", 58.4),
            "taux_60_64": 38.2,  # INSEE - beaucoup plus faible après 60 ans
            "chomage_seniors": 5.8,  # Taux de chômage des 55+
            "evolution_1an": 1.2,  # Évolution en points sur 1 an
            "duree_chomage_moyenne_mois": 18,  # Les seniors restent plus longtemps au chômage
            "taux_temps_partiel": 22.5,  # Part du temps partiel chez les 55+
            "comparaison_ue": {
                "france": derniers_seniors.get("taux", 58.4),
                "allemagne": 72.3,
                "moyenne_ue": 62.4,
                "suede": 77.0,
                "italie": 57.3
