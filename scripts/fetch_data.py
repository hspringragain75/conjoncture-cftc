...
def build_emploi_seniors_data():
    ...
    default_seniors = [
        ...
        {"trimestre": "T4 2023", "taux": 58.1},
        {"trimestre": "T1 2024", "taux": 58.8},
        {"trimestre": "T2 2024", "taux": 59.5},
        {"trimestre": "T3 2024", "taux": 60.2},
        {"trimestre": "T4 2024", "taux": 60.4},
        {"trimestre": "T1 2025", "taux": 60.8},
        {"trimestre": "T2 2025", "taux": 61.2},
...
def main():
    ...
    data = {
        ...
        "emploi_seniors_detail": {
            ...
            # Chômage - DARES 2024
            "chomage_seniors": 5.2,   # Inférieur à moyenne nationale (7.4%)
            ...
            # Source
            "sources": ["INSEE - Enquête Emploi 2024", "DARES", "Eurostat"]
        },
