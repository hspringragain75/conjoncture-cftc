        ...
        <>
          ...
          <BubbleNote type="info" title="💡 Utilisation en négociation" darkMode={darkMode}>
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li><b>Probabilités</b> : "{inflationCftc.probabilites?.inflation_sous_2pct || 'X'}% de chances que l'inflation reste sous 2%"</li>
              <li><b>Plancher</b> : Le SMIC augmente de {smicCftc.events?.[0]?.estimated_increase_pct || 'X'}%, les salaires doivent suivre</li>
              <li><b>Risques</b> : Mentionner les scénarios what-if (choc pétrolier, etc.)</li>
            </ol>
          </BubbleNote>
