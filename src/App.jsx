...
function ConjonctureTab({d, subTab, setSubTab, darkMode}) {
  ...
  return (
    <div className="space-y-4">
      <div className={`flex flex-wrap gap-2`}>
        {[['pib','📈 Croissance PIB'],['partage_va','⚖️ Partage VA'],['climat','🌡️ Climat affaires'],['defaillances','🏭 Défaillances'],['investissement','📉 Investissement']].map(([id,label])=>(
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {formation.cpf.top_formations.map((f, i) => (
                        <span key={i} className={`px-2 py-1 rounded-lg text-sm ${darkMode ? 'bg-gray-700' : 'bg-gray-100'}`}>
                          {f.nom} ({f.part_pct}%)
                        </span>
                      ))}
                    </div>
...
function TerritoiresTab({d, darkMode}) {
  ...
  // GeoJSON des régions françaises (données officielles IGN simplifiées)
  const regionsGeoJSON = {
    "type": "FeatureCollection",
    "features": [
      {"type":"Feature","properties":{"code":"11","nom":"Île-de-France"},"geometry":{"type":"Polygon","coordinates":[[[1.4463,49.0797],[1.5274,49.0588],[1.6018,49.0843],[1.7251,49.0424],[1.7953,48.9656],[1.9055,48.9387],[1.9872,48.9783],[2.1892,48.9599],[2.4169,48.9495],[2.5905,49.0797],[2.7818,49.0868],[2.8893,49.0375],[2.9419,48.9599],[2.9591,48.8504],[2.9367,48.7296],[3.0489,48.6577],[3.1366,48.5831],[3.1946,48.4589],[3.0911,48.3848],[2.8893,48.3659],[2.6578,48.3398],[2.5068,48.4116],[2.3854,48.3988],[2.3064,48.4486],[2.1586,48.4116],[1.9954,48.4486],[1.8933,48.4018],[1.7864,48.4636],[1.5948,48.4636],[1.4612,48.5334],[1.4463,48.6268],[1.5274,48.7579],[1.4463,48.8658],[1.4612,48.9599],[1.4463,49.0797]]]}},
      {"type":"Feature","properties":{"code":"24","nom":"Centre-Val de Loire"},"geometry":{"type":"Polygon","coordinates":[[[0.7725,48.3988],[0.9394,48.4636],[1.1174,48.4116],[1.2883,48.4486],[1.4463,48.5334],[1.4612,48.6268],[1.5274,48.7579],[1.4463,48.8658],[1.4612,48.9599],[1.5274,49.0588],[1.7251,49.0424],[1.7953,48.9656],[1.9055,48.9387],[1.9872,48.9783],[2.1586,48.9387],[2.3064,48.8658],[2.5068,48.8194],[2.6578,48.7579],[2.8893,48.7296],[3.0489,48.6577],[3.1366,48.5831],[3.1946,48.4589],[3.1366,48.2813],[3.0489,48.1142],[2.9367,47.9468],[2.8893,47.7791],[2.8068,47.6111],[2.9367,47.4428],[2.9591,47.2742],[2.8068,47.1265],[2.6578,46.9785],[2.5068,46.8513],[2.3064,46.7238],[2.1586,46.6169],[1.9872,46.4891],[1.7953,46.4891],[1.5948,46.5169],[1.4612,46.6169],[1.2883,46.7238],[1.1174,46.7446],[0.9394,46.8096],[0.7725,46.9368],[0.5847,47.0413],[0.4385,47.1882],[0.3171,47.3354],[0.2598,47.5031],[0.3171,47.6728],[0.3956,47.8423],[0.4385,48.0116],[0.5056,48.1596],[0.5847,48.2813],[0.6655,48.3659],[0.7725,48.3988]]]}},
      {"type":"Feature","properties":{"code":"94","nom":"Corse"},"geometry":{"type":"Polygon","coordinates":[[[8.5725,42.3788],[8.6218,42.5188],[8.6958,42.6388],[8.7944,42.7388],[8.9177,42.8187],[9.0657,42.8787],[9.2136,42.9187],[9.3616,42.9387],[9.5095,42.9187],[9.5588,42.8187],[9.5835,42.6988],[9.5835,42.5588],[9.5588,42.3988],[9.5095,42.2189],[9.4355,42.0389],[9.3369,41.8789],[9.2136,41.739],[9.0657,41.619],[8.893,41.519],[8.6958,41.439],[8.5478,41.4791],[8.4492,41.5591],[8.3752,41.659],[8.3259,41.779],[8.3012,41.919],[8.3012,42.0789],[8.3259,42.2189],[8.3752,42.3388],[8.4492,42.4388],[8.5725,42.3788]]]}}
    ]
  };

  // Convertir GeoJSON en paths SVG avec projection
  useEffect(() => {
    const width = 280;
    const height = 320;
    ...
    const project = (lon, lat) => {
      // Projection conique conforme de Lambert adaptée pour la France
      const centerLon = 2.5;
      const centerLat = 46.5;
      const scale = 2800;
      
      const x = (lon - centerLon) * Math.cos(centerLat * Math.PI / 180) * scale / 100;
      const y = -(lat - centerLat) * scale / 100;
      
      return [x + width / 2, y + height / 2];
    };
    
    // Convertir les coordonnées GeoJSON en path SVG
    ...
    // Calculer le centroïde pour les labels
    ...
    regionsGeoJSON.features.forEach(feature => {
      const code = codeMapping[feature.properties.code];
      if (code) {
        paths[code] = geoToPath(feature.geometry.coordinates);
        centroids[code] = getCentroid(feature.geometry.coordinates);
      }
    });
    
    setPathsData({ paths, centroids });
  }, []);
  ...
  const getColor = (region, metricType, isDark) => {
    ...
    if (metricType === 'chomage') {
      if (val < 6.5) return isDark ? '#22c55e' : '#16a34a';
      if (val < 7.5) return isDark ? '#facc15' : '#ca8a04';
      if (val < 8.5) return isDark ? '#f97316' : '#ea580c';
      return isDark ? '#ef4444' : '#dc2626';
    } else if (metricType === 'salaire') {
      if (val >= 2200) return isDark ? '#22c55e' : '#16a34a';
      if (val >= 2050) return isDark ? '#3b82f6' : '#2563eb';
      if (val >= 1980) return isDark ? '#facc15' : '#ca8a04';
      return isDark ? '#f97316' : '#ea580c';
    } else {
      if (val >= 68) return isDark ? '#f97316' : '#ea580c';
      if (val >= 60) return isDark ? '#facc15' : '#ca8a04';
      return isDark ? '#3b82f6' : '#2563eb';
    }
  };
  ...
  // Fonction pour trouver une région par son code
  const getRegionByCode = (code) => regions.find(r => r.code === code);
          ...
          <div className="flex-1 p-4">
            <div className="relative w-full max-w-xl mx-auto">
              ...
              >
                ...
                {/* Régions */}
                {pathsData.paths && Object.entries(pathsData.paths).map(([code, path]) => {
                  ...
                  const centroid = pathsData.centroids?.[code] || { x: 0, y: 0 };
                ...
                {/* Tooltip au survol */}
                {hoveredRegion && !selectedRegion && pathsData.centroids?.[hoveredRegion.code] && (
                  <g>
                    <rect
                      x={(pathsData.centroids[hoveredRegion.code]?.x || 0) - 45}
                      y={(pathsData.centroids[hoveredRegion.code]?.y || 0) - 26}
                      width="90"
                      height="16"
                      rx="4"
                    ...
                    />
                    <text
                      x={pathsData.centroids[hoveredRegion.code]?.x || 0}
                      y={(pathsData.centroids[hoveredRegion.code]?.y || 0) - 15}
                      textAnchor="middle"
                      fill="#ffffff"
                      fontSize="7"
                      fontWeight="600"
