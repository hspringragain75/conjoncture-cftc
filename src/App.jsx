    ...
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className={`flex flex-wrap gap-2 mb-4 border-b pb-3 overflow-x-auto ${darkMode ? 'border-gray-700' : ''}`}>
          {[['conjoncture','📈 Conjoncture'],['evolutions','📉 Évolutions'],['pouvoir_achat','💰 Pouvoir d\'achat'],['salaires','💵 Salaires'],['emploi','👥 Emploi'],['conditions_vie','🏠 Conditions vie'],['inflation','📊 Inflation'],['conventions','📋 Conventions'],['comparaison_ue','🇪🇺 Europe'],['simulateur','🧮 Simulateur NAO'],['aide','📖 Aide']].map(([id,label]) => (
