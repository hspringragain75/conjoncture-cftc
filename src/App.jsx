...
function GlobeTab({ darkMode }) {
  ...
  useEffect(() => {
    const loadAll = async () => {
      ...
      // Charger GeoJSON world
      const geo = await fetch('https://cdn.jsdelivr.net/npm/world-atlas@2/countries-110m.json')
        .then(r => r.json())
        .then(topo => window.d3.feature(topo, topo.objects.countries));
      setGeoData(geo);
    };
