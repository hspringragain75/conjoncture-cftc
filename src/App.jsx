...
function TerritoiresTab({d, darkMode}) {
  ...
  // Vrais tracés SVG des régions françaises (coordonnées géographiques simplifiées mais fidèles)
  const regionPaths = {
    'HDF': 'M 168,2 L 187,5 L 205,2 L 218,8 L 225,18 L 230,35 L 222,52 L 210,58 L 195,55 L 182,62 L 175,75 L 165,78 L 155,72 L 148,58 L 152,42 L 158,25 L 162,12 Z',
    'IDF': 'M 155,72 L 165,78 L 175,75 L 182,82 L 178,95 L 168,102 L 155,98 L 148,88 L 150,78 Z',
    'GES': 'M 182,62 L 195,55 L 210,58 L 222,52 L 235,58 L 248,72 L 252,88 L 248,108 L 238,125 L 225,135 L 208,138 L 195,132 L 185,118 L 178,102 L 178,95 L 182,82 L 175,75 Z',
    'NOR': 'M 85,42 L 102,35 L 118,38 L 135,42 L 148,48 L 152,42 L 148,58 L 155,72 L 150,78 L 148,88 L 138,95 L 125,92 L 108,88 L 95,82 L 82,72 L 78,58 Z',
    'BRE': 'M 18,68 L 35,58 L 52,55 L 68,58 L 78,58 L 82,72 L 78,82 L 68,92 L 55,98 L 42,102 L 28,98 L 18,92 L 8,82 L 5,72 L 12,65 Z',
    'PDL': 'M 42,102 L 55,98 L 68,92 L 78,82 L 95,82 L 108,88 L 115,102 L 112,118 L 105,135 L 92,148 L 75,152 L 58,148 L 45,138 L 38,125 L 35,112 Z',
    'CVL': 'M 108,88 L 125,92 L 138,95 L 148,88 L 155,98 L 168,102 L 178,102 L 185,118 L 182,135 L 172,152 L 158,162 L 142,165 L 128,158 L 118,145 L 112,128 L 112,118 L 115,102 Z',
    'BFC': 'M 185,118 L 195,132 L 208,138 L 225,135 L 238,142 L 242,158 L 238,175 L 228,192 L 215,202 L 198,205 L 182,198 L 172,185 L 168,168 L 172,152 L 182,135 Z',
    'NAQ': 'M 38,125 L 45,138 L 58,148 L 75,152 L 92,148 L 105,135 L 112,128 L 118,145 L 128,158 L 125,175 L 118,195 L 108,215 L 95,232 L 78,248 L 62,258 L 48,255 L 35,242 L 28,222 L 25,198 L 28,175 L 32,155 L 35,138 Z',
    'ARA': 'M 168,168 L 172,185 L 182,198 L 198,205 L 215,202 L 228,208 L 242,218 L 252,235 L 248,255 L 238,272 L 222,282 L 205,285 L 188,278 L 172,268 L 162,252 L 158,232 L 162,212 L 162,192 L 165,178 Z',
    'OCC': 'M 62,258 L 78,248 L 95,232 L 108,215 L 118,195 L 125,175 L 142,178 L 158,185 L 162,192 L 162,212 L 158,232 L 162,252 L 155,272 L 142,288 L 125,298 L 105,302 L 85,298 L 68,288 L 55,275 L 52,262 Z',
    'PAC': 'M 172,268 L 188,278 L 205,285 L 222,282 L 238,285 L 252,295 L 258,308 L 252,322 L 238,328 L 218,328 L 198,322 L 182,312 L 168,298 L 162,282 L 165,272 Z',
    'COR': 'M 275,298 L 282,295 L 288,302 L 292,318 L 290,338 L 285,352 L 278,358 L 272,352 L 270,335 L 272,315 Z'
  };

  // Positions des labels pour chaque région (centres approximatifs)
          ...
          <div className="flex-1 p-4">
            <div className="relative w-full max-w-xl mx-auto">
              ...
              >
                ...
                <g opacity="0.03">
                  {[...Array(16)].map((_, i) => (
                    <line key={`v${i}`} x1={i * 20} y1="0" x2={i * 20} y2="370" stroke={darkMode ? '#fff' : '#000'} />
                  ))}
                  {[...Array(19)].map((_, i) => (
                    <line key={`h${i}`} x1="0" y1={i * 20} x2="300" y2={i * 20} stroke={darkMode ? '#fff' : '#000'} />
                  ))}
                </g>
