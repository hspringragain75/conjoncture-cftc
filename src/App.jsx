  ...
  return (
    <div className="space-y-4">
      ...
      {subTab === 'marches' && d.marches_financiers && (() => {
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
          <KpiCard data={mf.lme_cuivre} label="Cuivre" unite="cts/lb" bgClass="bg-orange-900/20" borderClass="border-orange-800/50" badgeClass={darkMode ? 'bg-orange-800/50 text-orange-300' : 'bg-orange-100 text-orange-600'} textClass={darkMode ? 'text-orange-400' : 'text-orange-700'} />
          <KpiCard data={mf.lme_aluminium} label="Aluminium" unite="cts/lb" bgClass="bg-slate-900/20" borderClass="border-slate-800/50" badgeClass={darkMode ? 'bg-slate-800/50 text-slate-300' : 'bg-slate-100 text-slate-600'} textClass={darkMode ? 'text-slate-400' : 'text-slate-600'} />
          <KpiCard data={mf.lme_zinc} label="Zinc" unite="$/t" bgClass="bg-teal-900/20" borderClass="border-teal-800/50" badgeClass={darkMode ? 'bg-teal-800/50 text-teal-300' : 'bg-teal-100 text-teal-600'} textClass={darkMode ? 'text-teal-400' : 'text-teal-700'} format={v => v?.toLocaleString('fr-FR')} />
          <KpiCard data={mf.lme_nickel} label="Nickel" unite="$/t" bgClass="bg-emerald-900/20" borderClass="border-emerald-800/50" badgeClass={darkMode ? 'bg-emerald-800/50 text-emerald-300' : 'bg-emerald-100 text-emerald-600'} textClass={darkMode ? 'text-emerald-400' : 'text-emerald-700'} format={v => v?.toLocaleString('fr-FR')} />
        </div>
