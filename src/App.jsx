...
function buildCatalogue(d) {
  ...
  return [
    ...
    { id: 'climat_affaires', categorie: '📈 Conjoncture', label: 'Climat affaires',
      ...
      getSparkline: d => { const h = d.conjoncture?.climat_affaires?.evolution?.map(e=>e.climat)||[]; return h.length>=4 ? h.slice(-12) : serie([100,99,97,94,97,95,100,97,96,99,97], d.indicateurs_cles?.climat_affaires); },
      getStatus: () => 'neutral',
    ...
    { id: 'confiance_menages', categorie: '📈 Conjoncture', label: 'Confiance ménages',
      ...
      getSparkline: d => { const h = d.conjoncture?.climat_affaires?.evolution?.map(e=>e.menages)||[]; return h.length>=4 ? h.slice(-12) : serie([91,90,91,93,92,91,89,90,90,91,91], d.conjoncture?.climat_affaires?.confiance_menages); },
