  ...
  return (
    <div className="space-y-4">
      ...
      {subTab === 'partage_va' && <div className="space-y-4">
        ...
        <div className={`${darkMode ? 'bg-red-900/30' : 'bg-red-50'} border-l-4 border-red-400 p-4 rounded`}>
          ...
          <ul className="mt-2 text-sm text-red-700 space-y-1">
            <li>• La part des salaires dans la valeur ajoutée a évolué de <b>68% à 58%</b> entre 1980 et aujourd'hui</li>
            <li>• Le taux de marge des entreprises (SNF) : <b>32.5%</b> en 2024</li>
            <li>• Ces données permettent de comprendre le partage de la richesse créée</li>
          </ul>
        </div>
      </div>}
      ...
      {d.sources_par_onglet?.conjoncture && (
        <p className="text-xs text-gray-400 text-center mt-4 pt-4 border-t border-gray-200">
          📚 Sources : {d.sources_par_onglet.conjoncture}
        </p>
      )}
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      ...
      {d.sources_par_onglet?.comparaison_ue && (
        <p className="text-xs text-gray-400 text-center mt-4 pt-4 border-t border-gray-200">
          📚 Sources : {d.sources_par_onglet.comparaison_ue}
        </p>
      )}
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      ...
      {d.sources_par_onglet?.pouvoir_achat && (
        <p className="text-xs text-gray-400 text-center mt-4 pt-4 border-t border-gray-200">
          📚 Sources : {d.sources_par_onglet.pouvoir_achat}
        </p>
      )}
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      ...
      {d.sources_par_onglet?.emploi && (
        <p className="text-xs text-gray-400 text-center mt-4 pt-4 border-t border-gray-200">
          📚 Sources : {d.sources_par_onglet.emploi}
        </p>
      )}
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      ...
      {d.sources_par_onglet?.conditions_vie && (
        <p className="text-xs text-gray-400 text-center mt-4 pt-4 border-t border-gray-200">
          📚 Sources : {d.sources_par_onglet.conditions_vie}
        </p>
      )}
    </div>
  );
    ...
    <div className="space-y-4">
      ...
      <div className={`${darkMode ? 'bg-blue-900/30' : 'bg-blue-50'} border border-blue-200 rounded-lg p-4`}>
        ...
        <div className="text-sm text-blue-700 space-y-1">
          ...
          <p>• <b>Identifiez</b> l'écart entre le minimum de branche et le SMIC</p>
          <p>• <b>Consultez</b> régulièrement les avenants salaires de votre branche</p>
        </div>
      </div>
      ...
      {d.sources_par_onglet?.conventions && (
        <p className="text-xs text-gray-400 text-center mt-2">
          📚 Sources : {d.sources_par_onglet.conventions}
        </p>
      )}
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      ...
      <div className={`p-4 rounded-lg border ${darkMode ? 'bg-indigo-900/30 border-indigo-700' : 'bg-indigo-50 border-indigo-200'}`}>
        <h3 className={`font-semibold mb-2 ${darkMode ? 'text-indigo-300' : 'text-indigo-800'}`}>📖 Note de lecture</h3>
        <div className={`text-sm space-y-2 ${darkMode ? 'text-indigo-200' : 'text-indigo-700'}`}>
          {graphType === 'inflation_smic' && (
            <>
              ...
              <p>• <b>Observation</b> : Les salaires hors SMIC n'ont pas suivi la même dynamique</p>
            </>
          )}
          {graphType === 'chomage' && (
            <>
              ...
              <p>• <b>Observation</b> : Le marché du travail reste tendu avec des difficultés de recrutement</p>
            </>
          )}
          {graphType === 'salaires' && (
            <>
              ...
              <p>• <b>Observation</b> : L'écart SMIC-médian s'est légèrement réduit sur la période</p>
            </>
          )}
          {graphType === 'pib' && (
            <>
              ...
              <p>• <b>Observation</b> : La croissance économique a repris mais ralentit depuis 2023</p>
            </>
          )}
          {graphType === 'pouvoir_achat' && (
            <>
              ...
              <p>• <b>Observation</b> : Évolutions contrastées selon les niveaux de revenus</p>
            </>
          )}
          {graphType === 'defaillances' && (
            <>
              <p>• <b>Explosion des défaillances</b> : 32k (2020) → 68k (2025)</p>
              <p>• <b>Rattrapage post-COVID</b> des entreprises maintenues artificiellement par les aides</p>
              <p>• <b>Observation</b> : Retour aux niveaux pré-COVID après une période de soutien exceptionnel</p>
            </>
          )}
        </div>
      </div>
      ...
      {d.sources_par_onglet?.evolutions && (
        <p className="text-xs text-gray-400 text-center mt-2">
          📚 Sources : {d.sources_par_onglet.evolutions}
        </p>
      )}
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      ...
      <div className={`p-4 rounded-lg ${darkMode ? 'bg-purple-900/20 border border-purple-800' : 'bg-purple-50 border border-purple-200'}`}>
        ...
        {d.previsions?.sources && <p className="text-xs text-gray-500 mt-3 pt-2 border-t border-gray-300">📚 Sources : {d.previsions.sources}</p>}
      </div>
    </div>
  );
}
  ...
  return (
    <div className="space-y-4">
      ...
      {d.donnees_regionales?.sources && (
        <p className="text-xs text-gray-400 text-center mt-2">
          📚 Sources : {d.donnees_regionales.sources}
        </p>
      )}
    </div>
  );
...
function AideTab({darkMode}) {
  ...
  const glossaire = [
    ...
    { terme: "Partage de la VA", definition: "Répartition de la valeur ajoutée entre salaires (~60%), EBE/profits (~32%) et impôts (~8%). Indicateur clé du partage de la richesse.", categorie: "Partage VA", importance: "haute" },
    ...
    { terme: "Dividendes", definition: "Part des bénéfices distribuée aux actionnaires. Record en France: 67 Mds€ en 2023. Indicateur clé : le partage de la valeur.", categorie: "Partage VA", importance: "moyenne" },
    ...
    { terme: "Investissement", definition: "Dépenses d'équipement, R&D, formation... Nécessaires au développement de l'entreprise.", categorie: "Partage VA", importance: "moyenne" },
